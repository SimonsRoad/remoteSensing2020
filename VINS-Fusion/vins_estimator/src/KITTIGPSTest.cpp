...
Estimator estimator; // multiple sensor integration 
...
int main(int argc, char** argv)
{
	...
	pubGPS = n.advertise<sensor_msgs::NavSatFix>("/gps", 1000); // publish standard sensor_msgs::NavSatFix 

	if(argc != 3) // get the parameters
	{
	...
	string config_file = argv[1]; // get config file 
	printf("config_file: %s\n", argv[1]); // print
	string sequence = argv[2]; // get the 
